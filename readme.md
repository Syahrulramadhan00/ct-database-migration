...
first, make a copy of env and set your env :

    cp .env.example .env
    // format url ("protocol://username:password@host:port/database_name?options")

second, install dbmate. you can see in documentation below

last, run migration using command :
